(() => {
    ...
    function menuInit() {
        ...
        if (document.querySelector(".menu__body")) document.addEventListener("click", (e => {
            if ((e.target.closest(".menu__close") || !e.target.closest(".menu__body")) && !e.target.closest(".icon-menu")) {
                console.log("te");
                functions_menuClose();
            }
        }));
    ...
    function initSliders() {
        ...
        if (document.querySelector(".slider-exams__slider")) new swiper_core_Swiper(".slider-exams__slider", {
            modules: [ Autoplay ],
            observer: true,
            observeParents: true,
            slidesPerView: "auto",
        ...
        if (document.querySelector(".slider-events__slider")) new swiper_core_Swiper(".slider-events__slider", {
            modules: [ Autoplay ],
            observer: true,
            observeParents: true,
            slidesPerView: "auto",
    ...
    function headerScroll() {
        ...
        document.addEventListener("windowScroll", (function(e) {
            const topHeaderHeight = topHeader.clientHeight + 1;
            ...
            if (scrollTop >= topHeaderHeight) {
                ...
                if (!header.classList.contains("_header-scroll")) {
                    ...
                    header.style.cssText = `transform: translate(0, -${topHeaderHeight + "px"});`;
                }
                if (headerShow) {
